...
const TRANSLATIONS = {
  ...
  en: {
    ...
    ig_source: 'Source:',
    ig_card_title_week: 'TOP {{n}} {{icon}} {{type}} of the Week',
    ig_card_title_month: 'TOP {{n}} {{icon}} {{type}} of the Month',
    ig_card_title_year: 'TOP {{n}} {{icon}} {{type}} of {{year}}',
    ig_card_title_alltime: 'ALL-TIME TOP {{n}} {{icon}} {{type}}',
    ig_card_title_other: 'TOP {{n}} {{icon}} {{type}}',
    ig_word_songs: 'Songs',
    ig_word_artists: 'Artists',
    ig_word_albums: 'Albums',
    ig_footer_personal_music: 'PERSONAL MUSIC CHARTS',
    ig_footer_plays_label: 'Plays',
  ...
  es: {
    ...
    ig_source: 'Fuente:',
    ig_card_title_week: 'TOP {{n}} {{icon}} {{type}} de la Semana',
    ig_card_title_month: 'TOP {{n}} {{icon}} {{type}} del Mes',
    ig_card_title_year: 'TOP {{n}} {{icon}} {{type}} de {{year}}',
    ig_card_title_alltime: 'HISTÓRICO TOP {{n}} {{icon}} {{type}}',
    ig_card_title_other: 'TOP {{n}} {{icon}} {{type}}',
    ig_word_songs: 'Canciones',
    ig_word_artists: 'Artistas',
    ig_word_albums: 'Álbumes',
    ig_footer_personal_music: 'CHARTS MUSICALES PERSONALES',
    ig_footer_plays_label: 'Repros',
  ...
  'pt-BR': {
    ...
    ig_source: 'Fonte:',
    ig_card_title_week: 'TOP {{n}} {{icon}} {{type}} da Semana',
    ig_card_title_month: 'TOP {{n}} {{icon}} {{type}} do Mês',
    ig_card_title_year: 'TOP {{n}} {{icon}} {{type}} de {{year}}',
    ig_card_title_alltime: 'HISTÓRICO TOP {{n}} {{icon}} {{type}}',
    ig_card_title_other: 'TOP {{n}} {{icon}} {{type}}',
    ig_word_songs: 'Músicas',
    ig_word_artists: 'Artistas',
    ig_word_albums: 'Álbuns',
    ig_footer_personal_music: 'CHARTS MUSICAIS PESSOAIS',
    ig_footer_plays_label: 'Plays',

...
const TRANSLATIONS = {
  ...
  es: {
    ...
    ig_songs_word: 'canc.',
    ig_personal_charts: 'CHARTS PERSONALES DE MÚSICA',
    ...
    ep_of: 'de',
    ep_yearly_chart_line: 'Chart Anual de {{type}}',
    ...
    // IG Share modal range button tooltips
    tooltip_cr_ytd_week: 'Apariciones en el chart del 1 de enero hasta la semana vista (Acumulado del Año)',
    tooltip_cr_ytd_month: 'Apariciones en el chart del 1 de enero hasta el mes visto (Acumulado del Año)',
    tooltip_cr_upto_week: 'Todas las apariciones en el chart desde tu primer scrobble hasta la semana vista inclusive',
    tooltip_cr_upto_month: 'Todas las apariciones en el chart desde tu primer scrobble hasta el mes visto inclusive',
    tooltip_cr_year_only_range: 'Solo las apariciones en el chart dentro del año seleccionado',
    tooltip_cr_upto_year_range: 'Todas las apariciones en el chart desde tu primer scrobble hasta el año seleccionado inclusive',
    tooltip_cr_all_time_range: 'Todas las apariciones en el chart a lo largo de todo tu historial de scrobbles',
    ...
    desc_returns_welcome: '¡Regresa al chart en el #{{rank}} \u2014 bienvenido/a de vuelta!',
    desc_debut_no_hist: 'Hace su debut en el chart en el #{{rank}}.',
    desc_return_after_gap: 'Regresa al chart en el #{{rank}} tras {{n}} {{unit}} de ausencia.',
    ...
    desc_debut_top10: 'Entra al chart en el Top 10, debutando en el #{{rank}}.',
    desc_debut: 'Hace su debut en el chart en el #{{rank}}.',
    ...
    desc_hold_long: 'Permanece en el #{{rank}} \u2014 {{n}} {{units}} en el chart y contando.',
    desc_hold_cons: 'Se mantiene en el #{{rank}} durante {{n}} {{units}} consecutivas.',
    desc_hold: 'Se mantiene en el #{{rank}}.',
    desc_ascend_1_hist: '¡Asciende al #1 por primera vez tras {{n}} {{units}} en el chart!',
    ...
    desc_rockets_hist: 'Sube {{diff}} posiciones hasta el #{{rank}} \u2014 {{n}} {{units}} en el chart.',
    ...
    desc_rises_streak: 'Sube {{diff}} {{posn}} hasta el #{{rank}} \u2014 {{n}} {{units}} en el chart.',
    ...
    desc_tumbles_streak: 'Cae {{drop}} posiciones al #{{rank}} \u2014 todavía {{n}} {{units}} en el chart.',
    desc_tumbles: 'Cae {{drop}} posiciones al #{{rank}}.',
    desc_falls_remarkable: 'Baja {{drop}} {{spot}} al #{{rank}} \u2014 un notable {{n}} {{units}} en el chart.',
    desc_slips_streak: 'Baja {{drop}} {{posn}} al #{{rank}} tras {{n}} {{units}} en el chart.',
    desc_falls: 'Baja {{drop}} {{posn}} al #{{rank}}.',
    desc_v_prefix_chart: 'En este chart: ',
  ...
  'pt-BR': {
    ...
    ig_plays_word: 'reprod.',
    ig_songs_word: 'canc.',
    ig_personal_charts: 'CHARTS PESSOAIS DE MÚSICA',
    ...
    // IG Share modal range button tooltips
    tooltip_cr_ytd_week: 'Aparições no chart de 1º de janeiro até a semana vista (Acumulado do Ano)',
    tooltip_cr_ytd_month: 'Aparições no chart de 1º de janeiro até o mês visto (Acumulado do Ano)',
    tooltip_cr_upto_week: 'Todas as aparições no chart desde o seu primeiro scrobble até a semana vista inclusive',
    tooltip_cr_upto_month: 'Todas as aparições no chart desde o seu primeiro scrobble até o mês visto inclusive',
    tooltip_cr_year_only_range: 'Apenas as aparições no chart dentro do ano selecionado',
    tooltip_cr_upto_year_range: 'Todas as aparições no chart desde o seu primeiro scrobble até o ano selecionado inclusive',
    tooltip_cr_all_time_range: 'Todas as aparições no chart ao longo de todo o seu histórico de scrobbles',
    ...
    desc_returns_welcome: 'Retorna ao chart no #{{rank}} \u2014 bem-vindo/a de volta!',
    desc_debut_no_hist: 'Estreia no chart no #{{rank}}.',
    desc_return_after_gap: 'Retorna ao chart no #{{rank}} após {{n}} {{unit}} de ausência.',
    desc_debut_1: 'Explode no chart direto no #1 \u2014 uma estreia no topo!',
    desc_debut_top5: 'Estreia impressionante no #{{rank}}, entrando no Top 5.',
    desc_debut_top10: 'Entra no chart no Top 10, estreando no #{{rank}}.',
    desc_debut: 'Estreia no chart no #{{rank}}.',
    ...
    desc_hold_long: 'Mantém-se no #{{rank}} \u2014 {{n}} {{units}} no chart e contando.',
    desc_hold_cons: 'Permanece no #{{rank}} por {{n}} {{units}} consecutivas.',
    desc_hold: 'Mantém-se no #{{rank}}.',
    desc_ascend_1_hist: 'Chega ao #1 pela primeira vez após {{n}} {{units}} no chart!',
    ...
    desc_rockets_hist: 'Dispara {{diff}} posições até o #{{rank}} \u2014 {{n}} {{units}} no chart.',
    ...
    desc_rises_streak: 'Sobe {{diff}} {{posn}} até o #{{rank}} \u2014 {{n}} {{units}} no chart.',
    ...
    desc_tumbles_streak: 'Cai {{drop}} posições para o #{{rank}} \u2014 ainda {{n}} {{units}} no chart.',
    desc_tumbles: 'Cai {{drop}} posições para o #{{rank}}.',
    desc_falls_remarkable: 'Cai {{drop}} {{spot}} para o #{{rank}} \u2014 notáveis {{n}} {{units}} no chart.',
    desc_slips_streak: 'Cai {{drop}} {{posn}} para o #{{rank}} após {{n}} {{units}} no chart.',
    desc_falls: 'Cai {{drop}} {{posn}} para o #{{rank}}.',
    desc_v_prefix_chart: 'Neste chart: ',
  ...
  'pt-PT': {
    ...
    // IG Share modal range button tooltips
    tooltip_cr_ytd_week: 'Aparições no chart de 1 de janeiro até à semana vista (Acumulado do Ano)',
    tooltip_cr_ytd_month: 'Aparições no chart de 1 de janeiro até ao mês visto (Acumulado do Ano)',
    tooltip_cr_upto_week: 'Todas as aparições no chart desde o seu primeiro scrobble até à semana vista inclusive',
    tooltip_cr_upto_month: 'Todas as aparições no chart desde o seu primeiro scrobble até ao mês visto inclusive',
    tooltip_cr_year_only_range: 'Apenas as aparições no chart dentro do ano selecionado',
    tooltip_cr_upto_year_range: 'Todas as aparições no chart desde o seu primeiro scrobble até ao ano selecionado inclusive',
    tooltip_cr_all_time_range: 'Todas as aparições no chart ao longo de todo o seu histórico de scrobbles',
    ...
    desc_spot_one: 'posição',
    desc_spot_other: 'posições',
    desc_returns_welcome: 'Regressa ao chart no #{{rank}} \u2014 bem-vindo/a de volta!',
    desc_debut_no_hist: 'Estreia no chart no #{{rank}}.',
    desc_return_after_gap: 'Regressa ao chart no #{{rank}} após {{n}} {{unit}} de ausência.',
    desc_debut_1: 'Entra no chart directamente no #1 \u2014 uma estreia no topo!',
    desc_debut_top5: 'Estreia impressionante no #{{rank}}, entrando no Top 5.',
    desc_debut_top10: 'Entra no chart no Top 10, estreando no #{{rank}}.',
    desc_debut: 'Estreia no chart no #{{rank}}.',
    ...
    desc_hold_long: 'Permanece no #{{rank}} \u2014 {{n}} {{units}} no chart e a contar.',
    ...
    desc_peak_top10: 'Atinge novo pico no #{{rank}} após {{n}} {{units}} consecutivas no Top 10.',
    desc_peak: 'Sobe para novo pico no #{{rank}}, subindo {{diff}} do #{{prev}}.',
    desc_rockets_hist: 'Dispara {{diff}} posições até ao #{{rank}} \u2014 {{n}} {{units}} no chart.',
    ...
    desc_breaks_top10: 'Entra no Top 10 no #{{rank}}, subindo {{diff}} do #{{prev}}.',
    desc_top5: 'Entra no Top 5 no #{{rank}}.',
    desc_rises_streak: 'Sobe {{diff}} {{posn}} até ao #{{rank}} \u2014 {{n}} {{units}} no chart.',
